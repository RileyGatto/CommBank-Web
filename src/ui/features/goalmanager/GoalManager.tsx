...
import { faSmile } from '@fortawesome/free-regular-svg-icons'; // or appropriate location 
import GoalIcon from '../../features/goalmanager/GoalIcon'; // Update path as necessary
import {updateGoal as updatedGoalAPI } from '../../../api/lib'
...
export function GoalManager(props: Props) {
  ...
  const pickEmojiOnClick = (emoji: BaseEmoji, event: React.MouseEvent<Element>) => {
    event.stopPropagation()
  ...
  return (
    <GoalManagerContainer>
      ...
      {/* Add the EmojiPickerContainer to your return here */}
